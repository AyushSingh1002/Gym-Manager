...
import { Dumbbell, Phone, Lock, ArrowRight } from "lucide-react"
    ...
    <div className="min-h-screen bg-canvas flex items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-ink-muted mt-1">Your fitness journey starts here</p>
        </div>

        <div className="border border-hairline rounded-[var(--radius-lg)] bg-surface-1 p-6">
          <h2 className="text-base font-semibold text-ink mb-5">Sign In</h2>
