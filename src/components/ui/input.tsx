    ...
    return (
      <div className="space-y-2">
        ...
        <div className="relative">
          {icon && (
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-ink-tertiary flex-shrink-0">
              {icon}
            </div>
          )}
          <input
            ...
            ref={ref}
            className={cn(
              "block w-full rounded-[var(--radius-md)] border bg-surface-1 px-3.5 py-2.5 text-sm text-ink placeholder-ink-subtle transition-all duration-150",
